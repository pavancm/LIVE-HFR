...
"%" is a number denoting CRF level used for compressing the source sequence.

"&" denotes the fps value of the video. For each source sequence there are 6 different fps values - 24, 30, 60, 82, 98 and 120 fps. 

Every source sequence across fps values contains CRF=0 video, which is lossless compression.
## Subjective Scores
